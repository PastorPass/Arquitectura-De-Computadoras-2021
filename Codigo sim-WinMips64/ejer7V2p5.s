...
.code
  ...
  ; sin copia de la dir de tabla en otro registro($s0..etc)
  mayorQueNum: 
			   ;cargo con la direccion de tabla, el 1er elemento en $t0
		 loop: ld $t0, 0($a1) ; $t0 = 1er elemento de la tabla
			   nop
			   ;comparo
		       ...
		       busco: daddi $a1,$a1,8  ; sumo el desplazamiento +8 en la dir de tabla
